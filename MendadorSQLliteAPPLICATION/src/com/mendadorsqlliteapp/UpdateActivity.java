...
import com.mendadorsqlliteapp.R;
...
public class UpdateActivity extends Activity {
	...
	public void updateRecord(View view) {
		...
		if(conn.hasDuplicate(fName, mName, lName, ID)) {
			Toast.makeText(getApplicationContext(), "CANNOT UPDATE, DATA HAS DUPLICATE!", Toast.LENGTH_SHORT).show();
			return;
		}
